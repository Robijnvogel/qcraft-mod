...
public class GuiQuantumComputer extends GuiContainer {
    ...
    private void updateStatus() {
        ...
        if (isTeleporter) {
            if (buttonList.contains(m_energizeButton)) {
                buttonList.remove(m_energizeButton);
            }
            if (!buttonList.contains(m_energizeButton2)) {
                buttonList.add(m_energizeButton2);
            }
            if (m_addingServer) {
                if (buttonList.contains(m_changeServerButton)) {
                    buttonList.remove(m_changeServerButton);
                }
                if (buttonList.contains(m_addServerButton)) {
                    buttonList.remove(m_addServerButton);
                }
                if (buttonList.contains(m_removeServerButton)) {
                    buttonList.remove(m_removeServerButton);
                }
                if (!buttonList.contains(m_confirmAddServerButton)) {
                    buttonList.add(m_confirmAddServerButton);
                }
            } else {
                if (!buttonList.contains(m_changeServerButton)) {
                    buttonList.add(m_changeServerButton);
                }
                if (!buttonList.contains(m_addServerButton)) {
                    buttonList.add(m_addServerButton);
                }
                if (!buttonList.contains(m_removeServerButton)) {
                    buttonList.add(m_removeServerButton);
                }
                if (buttonList.contains(m_confirmAddServerButton)) {
                    buttonList.remove(m_confirmAddServerButton);
                }
            }
        } else {
            if (!buttonList.contains(m_energizeButton)) {
                buttonList.add(m_energizeButton);
            }
            if (buttonList.contains(m_energizeButton2)) {
                buttonList.remove(m_energizeButton2);
            }
            if (buttonList.contains(m_changeServerButton)) {
                buttonList.remove(m_changeServerButton);
            }
